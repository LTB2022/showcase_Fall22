...
class Home(State):
    ...
    def enter(self, machine):
        ...
        win.geometry('600x400')                                         # Dimensions of the window, 320x240 is the dimensions of the adafruit PiTFT capacitive screen
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=LTB_label, fg_color=("white", "black"),
                                       font=customtkinter.CTkFont(size=40, weight="bold"), corner_radius=4)
        label.grid(row=1, column=1, columnspan=2, padx=10, pady=10, sticky="snwe")
        # tkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="EE Intern", font=customtkinter.CTkFont(size=40, weight="bold"),command=SW1ON)
        SW1Button.grid(row=3, column=0, padx=60, pady=60, sticky="w")
        SW2Button = customtkinter.CTkButton(master=win, text="CSUS 193B", font=customtkinter.CTkFont(size=40, weight="bold"),command=SW2ON)
        SW2Button.grid(row=3, column=3, padx=60, pady=60, sticky="e")
        Fbtn = customtkinter.CTkButton(master=win, text="Focus",font=customtkinter.CTkFont(size=40, weight="bold"),
                                       command=focusON)
        Fbtn.grid(row=0, column=3, padx=40, pady=40, sticky="ne")
        # Display Parameters for the Clock
        clkText = customtkinter.CTkLabel(master=win, text="Time :", font=customtkinter.CTkFont(size=20, weight="bold"))
        clkText.grid(row=0, column=0, padx=18, pady=50, sticky="nw")
        clock = customtkinter.CTkLabel(master=win, font=customtkinter.CTkFont(size=20))
        clock.grid(row=0, column=0, padx=90, pady=50, sticky="nw")
        # Display Parameters for the Date
        datetxt = customtkinter.CTkLabel(master=win, text="Date :", font=customtkinter.CTkFont(size=20, weight="bold"))
        datetxt.grid(row=0, column=0, padx=20, pady=10, sticky="nw")
        date = customtkinter.CTkLabel(master=win, font=customtkinter.CTkFont(size=20))
        date.grid(row=0, column=0, padx=90, pady=10, sticky="nw")
        get_time()
...
class FocusTimer(State):
    ...
    def enter(self, machine):
        ...
        fkslabel = customtkinter.CTkLabel(master=win, textvariable=focuslabel, fg_color=("white", "black"),
                                          corner_radius=8, font=customtkinter.CTkFont(size=30, weight="bold"))
        fkslabel.grid(row=0, column=1, rowspan=1, columnspan=1, padx=20, pady=20, sticky="ne")
        ...
        paralabel.grid(row=0, column=0, padx=20, pady=20, sticky="nw")
        # Focus timer countdown label
        countLabel = customtkinter.CTkLabel(master=win, text="", font=customtkinter.CTkFont(size=30))
        countLabel.grid(row=1, column=0, padx=40, sticky="w")
        focus_count()
        # tkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="Stop", command=SW1ON)
        SW1Button.grid(row=1, column=1, columnspan=1, padx=40, pady=100, sticky="se")
...
class EEIntern(State):
    ...
    def enter(self, machine):
        ...
        label.grid(row=0, column=1, rowspan=1, padx=20, pady=20, sticky="ne")
        # tkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="Timecard", command=SW1ON)
        SW1Button.grid(row=1, column=0, columnspan=1, padx=60, pady=100, sticky="w")
        SW2Button = customtkinter.CTkButton(master=win, text="Intern Project", command=SW2ON)
        SW2Button.grid(row=1, column=1, columnspan=1, padx=60, pady=100, sticky="e")
        # Home Button
        HomeButton = customtkinter.CTkButton(master=win,text="Home",
                                             font=customtkinter.CTkFont(size=30, weight="bold"),
                                            command=GoHome)
        HomeButton.grid(row=0, column=0, padx=60, pady=20, sticky="nw")
...
class Timecard(State):
    ...
    def enter(self, machine):
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=p1t1label, font=customtkinter.CTkFont(size=24, weight="bold"),
                               fg_color=("white", "black"), corner_radius=4)
        label.grid(row=0, column=1, rowspan=1, padx=20, pady=20, sticky="ne")
        # Tracked time Label
        trackLabel = customtkinter.CTkLabel(master=win, text="", font=customtkinter.CTkFont(size=20),
                                            fg_color=("white", "black"))
        trackLabel.grid(row=0, column=0, padx=60, pady=20, sticky="nw")
        elapsed_count()                                               	# "count up" timer function call
        # tkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="Stop", command=SW1ON)
        SW1Button.grid(row=1, column=1, columnspan=1, padx=60, pady=100, sticky="w")
        SW2Button = customtkinter.CTkButton(master=win, text="Home", command=SW2ON)
        SW2Button.grid(row=1, column=0, columnspan=1, padx=60, pady=100, sticky="e")
...
class EEProject(State):
    ...
    def enter(self, machine):
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=p1t2label, font=customtkinter.CTkFont(size=24, weight="bold"),
                                       fg_color=("white", "black"), corner_radius=4)
        label.grid(row=0, column=1, rowspan=1, padx=20, pady=20, sticky="ne")
        # Tracked time Label
        trackLabel = customtkinter.CTkLabel(master=win, text="", font=customtkinter.CTkFont(size=20),
...
class EEE193B(State):
    ...
    def enter(self, machine):
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=EEE193B_label, font=customtkinter.CTkFont(size=24, weight="bold"),
                                   fg_color=("white", "black"), corner_radius=4)
        label.grid(row=0, column=3, rowspan=1, padx=20, pady=20, sticky="ne")
        # customtkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="Assignments", font=customtkinter.CTkFont(size=40),command=SW1ON)
        SW1Button.grid(row=1, column=0, columnspan=1, padx=40, pady=100, sticky="e")
        SW2Button = customtkinter.CTkButton(master=win, text="Development", font=customtkinter.CTkFont(size=40),command=SW2ON)
        SW2Button.grid(row=1, column=3, columnspan=1, padx=40, pady=100, sticky="w")
        # Home Button
        HomeButton = customtkinter.CTkButton(master=win, text="Home",
                                             font=customtkinter.CTkFont(size=30, weight="bold"),
                                             command=GoHome)
...
class Assignments(State):
    ...
    def enter(self, machine):
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=p2t1label, font=customtkinter.CTkFont(size=24, weight="bold"),
                                       fg_color=("white", "black"), corner_radius=4)
        label.grid(row=0, column=1, rowspan=1, padx=20, pady=20, sticky="ne")
        # Tracked time Label
        trackLabel = customtkinter.CTkLabel(master=win, text="", font=customtkinter.CTkFont(size=20),
        ...
        elapsed_count()                                               	# calls the "count up timer" function
        # tkinter switch instances
        SW1Button = customtkinter.CTkButton(master=win, text="Stop", command=SW1ON,font=customtkinter.CTkFont(size=40))
        SW1Button.grid(row=1, column=0, columnspan=1, padx=60, pady=100, sticky="w")
        SW2Button = customtkinter.CTkButton(master=win, text="Home", command=SW2ON,font=customtkinter.CTkFont(size=40))
        SW2Button.grid(row=1, column=1, columnspan=1, padx=60, pady=100, sticky="e")
...
class Development(State):
    ...
    def enter(self, machine):
        ...
        label = customtkinter.CTkLabel(master=win, textvariable=p2t2label,corner_radius=4,
                                       font=customtkinter.CTkFont(size=24, weight="bold"),
                                       fg_color=("white", "black"))
        label.grid(row=0, column=1, rowspan=1, padx=20, pady=20, sticky="ne")
        # Tracked time Label
